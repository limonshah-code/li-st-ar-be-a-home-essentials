...
category: [Home Cleaning, Upholstery Care]
tags:
  - dry sofa cleaning
  - fabric sofa care
  - spot cleaning sofa
...
*   **Rubbing alcohol or distilled white vinegar (for specific stains on "S" coded fabrics):** While the main goal is "without water," some very specific stains might benefit from a *small* amount of these for their drying properties on "S" code fabrics. Use with extreme caution and test in an inconspicuous area. Remember, the focus is dry cleaning.
*   **Empty spray bottle (for very diluted solutions, if applicable for S/W codes, or for solvent spray):** If you use a commercial solvent that needs to be sprayed, or if your sofa is "S/W" and you opt for a *minimal*, quick-drying application of rubbing alcohol for certain stains, a fine mist spray bottle is useful. Ensure the spray is very fine to avoid saturating the fabric.
...
*   **Method:**
    ...
    2.  **Baking soda paste (minimal moisture):** For "S" coded fabrics, you can make a *very dry* paste by mixing baking soda with just enough dry cleaning solvent to form a thick consistency. Apply a small amount to the smudged area.
...
*   **Method:**
    ...
    5.  **Enzyme cleaner (for odor):** For lingering odors, particularly urine, consider a specialized enzymatic cleaner *designed for upholstery and safe for dry cleaning*. These cleaners break down odor-causing molecules. Read the instructions carefully and ensure it is water-free. Apply minimally with a cloth, blot, and let air dry. Always confirm the product is safe for your fabric code.
...
4.  **Apply the solvent:**
    ...
    *   **For spray solvents:** Spray a *very light mist* directly onto the stain or soiled area, or onto a clean cloth first, then apply. Avoid over-saturating the fabric.
...
*   **Method:**
    ...
    5.  **Spot treatment for light stains:** For very light, non-oily stains, you can make a paste by mixing baking soda with a *tiny* amount of rubbing alcohol (for "S" fabrics) or just enough water to make a very dry paste (for "W" or "S/W" fabrics). Apply this paste to the stain, let it dry completely, then brush and vacuum it away. Remember, for true "water-free," use rubbing alcohol if appropriate for your fabric type. This strategy is also useful for [how to clean couch with baking soda](https://homeessentialsguide.com/how-to-clean-couch-with-baking-soda) in general.
...
*   **Spot Cleaning:**
    *   **For "S" coded:** Lightly dampen a microfiber cloth with a suitable dry cleaning solvent. Gently *blot* the stain. Do not rub. Work with the nap of the fabric.
